...
static const gpio_config_t gpio_initial_config[] =
{
    ...
    {GPIO_MOTORS_LEFT_CC_1, GPIO_OUTPUT, GPIO_LOW, RESISTOR_PULLDOWN, GPIO_SEL_GPIO},
    {GPIO_MOTORS_LEFT_CC_2, GPIO_OUTPUT, GPIO_LOW, RESISTOR_PULLDOWN, GPIO_SEL_GPIO},
    {GPIO_MOTORS_RIGHT_CC_1, GPIO_OUTPUT, GPIO_LOW, RESISTOR_PULLDOWN, GPIO_SEL_GPIO},
    {GPIO_MOTORS_RIGHT_CC_2, GPIO_OUTPUT, GPIO_LOW, RESISTOR_PULLDOWN, GPIO_SEL_GPIO},
