...
typedef enum
{
    ...
    GPIO_MOTORS_LEFT_CC_1 = GPIO_MAKE(GPIO_PORT_1, BIT3),
    GPIO_MOTORS_LEFT_CC_2 = GPIO_MAKE(GPIO_PORT_1, BIT4),
    GPIO_MOTORS_RIGHT_CC_1 = GPIO_MAKE(GPIO_PORT_1, BIT5),
    GPIO_MOTORS_RIGHT_CC_2 = GPIO_MAKE(GPIO_PORT_1, BIT6),
