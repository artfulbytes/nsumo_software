...
typedef enum {
    ...
    GPIO_XSHUT_RIGHT = GPIO_15,
    GPIO_I2C_SCL = GPIO_16,
    GPIO_I2C_SDA = GPIO_17,
    /* Port 2 */
    GPIO_RANGE_SENSOR_FRONT_INT = GPIO_20,
    GPIO_XSHUT_FRONT = GPIO_21,
    GPIO_XSHUT_FRONT_LEFT = GPIO_22,
    GPIO_LINE_DETECT_BACK_LEFT = GPIO_23,
    GPIO_MOTORS_LEFT_CC_1 = GPIO_24,
    GPIO_MOTORS_LEFT_CC_2 = GPIO_25,
    GPIO_P26_UNUSED = GPIO_26,
    GPIO_MOTORS_RIGHT_CC_2 = GPIO_27,
    /* Port 3 */
    GPIO_XSHUT_FRONT_RIGHT = GPIO_30,
    GPIO_LINE_DETECT_FRONT_RIGHT = GPIO_31,
    GPIO_LINE_DETECT_FRONT_LEFT = GPIO_32,
    GPIO_XSHUT_LEFT = GPIO_33,
    GPIO_LINE_DETECT_BACK_RIGHT = GPIO_34,
